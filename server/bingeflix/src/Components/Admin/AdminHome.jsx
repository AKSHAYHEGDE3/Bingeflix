...
const AdminHome = () => {
    ...
    useEffect(() => {
       ...
       try{
            ...
            fetch("/fetchAllVideos?type=movies&genre=all").then(res=>res.json()).then(r=>setMovies(r));

            fetch("/fetchAllVideos?type=series&genre=all").then(res=>res.json()).then(r=>setSeries(r));

            fetch("/fetchAllVideos?type=animes&genre=all").then(res=>res.json()).then(r=>setAnimes(r));
       } catch(err){
           console.log(err)
       }
    }
